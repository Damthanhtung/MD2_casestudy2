...
let theListAlbum: AlbumManager = new AlbumManager();
let theListSong: SongManager = new SongManager();
        ...
        if (test == false) {
            ...
            do {
                ...
                if (test == false) {
                    ...
                    let account = new Account(1,useNameDone, passWordDone);
    ...
    do {
        ...
        do {
            ...
            if (testSongName == false) {
                ...
                let creator = input.question(`\x1b[1m  Enter Creator Name:  \x1b[0m`);
                let singer = input.question(`\x1b[1m  Enter Singer Name:  \x1b[0m`);
                let type = input.question(`\x1b[1m  Enter Type Name:  \x1b[0m`);
                let releaseDate = input.question(`\x1b[1m  Enter ReleaseDate:  \x1b[0m`);
                let numberOfListens = +input.question(`\x1b[1m  Enter NumberOfListens:  \x1b[0m`);

                nameSongDone = nameSong;
                let song = new Song(idSong, nameSongDone,creator, singer, type, releaseDate,numberOfListens);
...
function editSong() {
    ...
    if (songID == -1) {
        ...
        theListSong.edit(id, new Song(id, name,creator, singer, type, releaseDate, numberOfListens));
    }
...
function showAllSong() {
    console.log(theListSong.displayAllSong());
}
